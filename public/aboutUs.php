    ...
    <div>
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-lg-6 d-flex justify-content-center" data-aos="fade-right">
                <img class="img-fluid" src="../public/assets/img/mission-vector.png" alt="">
            </div>
        ...
        <div class="my-5" data-aos="fade-up">
            ...
            <ul style="list-style-type: none;">
                ...
                <li class="mt-3"><strong class="rating-view mb-4" style="display: list-item; width: fit-content; margin-left:auto;margin-right:auto">Secure Payments</strong> Our integrated PayPal payment system ensures secure and seamless transactions, giving both owners and drivers peace of mind.</li>
                <li class="mt-3"><strong class="rating-view mb-4" style="display: list-item; width: fit-content; margin-left:auto;margin-right:auto">Location-Based Search</strong> Easily locate and book cars in your vicinity. Our platform allows you to search for available cars based on your location, making the process quick and efficient.</li>
                <li class="mt-3"><strong class="rating-view mb-4" style="display: list-item; width: fit-content; margin-left:auto;margin-right:auto">Dedicated Support</strong> Our customer support team is here to assist both car owners and drivers. We're committed to ensuring a positive and transparent rental experience for everyone.</li>
            </ul>
        </div>
